...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SJMA180_1296X20X1BM1_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA180_512X64X1BM1_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA180_80X40X1BM1_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/SJMA180_1296X20X1BM1_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA180_512X64X1BM1_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA180_80X40X1BM1_WC.lib]\
   -si\
