...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _183830_archive_1.so
_183830_archive_1.so : archive.12/_183830_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_183830_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_183830_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/qndjy.o objs/udps/Sbaqa.o objs/udps/ySdCA.o 
